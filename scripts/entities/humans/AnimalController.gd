...
## Animal entity - wanders in Human World, provides essence when killed
## Flees from threats (Dark Lord, minions) when detected

const Data := preload("res://scripts/entities/humans/AnimalData.gd")
