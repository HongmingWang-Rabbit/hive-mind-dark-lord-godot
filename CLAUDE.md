...
GROUP_ALARM_TOWERS, GROUP_POLICE_STATIONS, GROUP_MILITARY_PORTALS

# Combat - Enemies (unified dictionary pattern)
ENEMY_STATS[EnemyType] = {hp, damage, speed, group}
# Example: GameConstants.ENEMY_STATS[Enums.EnemyType.SWAT].hp

# Enemy Spawning
SWAT_SPAWN_INTERVAL, MILITARY_SPAWN_INTERVAL, HEAVY_SPAWN_INTERVAL, PSYCHIC_SPAWN_INTERVAL
MAX_SWAT, MAX_MILITARY, MAX_HEAVY, MAX_SPECIAL_FORCES, MAX_PSYCHIC
ENEMY_SPAWN_MARGIN
