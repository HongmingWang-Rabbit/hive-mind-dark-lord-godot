...
ANIMAL_COUNT, ENTITY_SPAWN_ATTEMPTS

# Civilian Houses (spawn and maintain civilians)
CIVILIAN_HOUSE_COUNT, MAX_CIVILIANS_PER_HOUSE, CIVILIAN_HOUSE_SPAWN_INTERVAL

# Police Stations (spawn and maintain policemen)
POLICE_STATION_COUNT, MAX_POLICEMEN_PER_STATION, POLICE_STATION_SPAWN_INTERVAL

# Military Portals (travel gateway at 70%+ threat, enemies invade Corrupted World)
MILITARY_PORTAL_THREAT_THRESHOLD, MILITARY_PORTAL_SPAWN_INTERVAL
MILITARY_PORTAL_MAX_COUNT

# Combat - Dark Lord
DARK_LORD_HP, DARK_LORD_DAMAGE
DARK_LORD_ATTACK_RANGE, DARK_LORD_ATTACK_COOLDOWN

# Human Entities (unified dictionary pattern)
HUMAN_ENTITY_STATS[HumanType] = {hp, damage, essence_reward, group}
# Example: GameConstants.HUMAN_ENTITY_STATS[Enums.HumanType.CIVILIAN].hp
...
GROUP_ENEMIES, GROUP_SWAT, GROUP_MILITARY, GROUP_PSYCHIC
GROUP_BUILDINGS, GROUP_PORTALS, GROUP_CORRUPTION_NODES, GROUP_SPAWNING_PITS
GROUP_ALARM_TOWERS, GROUP_POLICE_STATIONS, GROUP_MILITARY_PORTALS, GROUP_CIVILIAN_HOUSES

# Combat - Enemies (unified dictionary pattern, includes spawn config)
ENEMY_STATS[EnemyType] = {hp, damage, speed, group, spawn_interval, max_count, min_threat}
# Example: GameConstants.ENEMY_STATS[Enums.EnemyType.SWAT].hp
ENEMY_SPAWN_MARGIN

# Input Keys (data-driven)
SPAWN_HOTKEYS[Key] = MinionType  # KEY_1 -> CRAWLER, KEY_2 -> BRUTE, etc.
ORDER_CURSOR_COLORS[MinionAssignment] = Color  # Attack, Defend, Scout colors
ORDER_STANCES[MinionAssignment] = Stance  # Assignment -> Stance mapping
